"""
04_make_tables.py — Final experiment, step 4: fleet-level summary tables
for one-shot vs. periodic similarity matching, one table for Health Index
and one for RUL, both read back from results.db.
...
OUTPUT
============================================================================
  - experiments/final_experiment/tables/health_index_summary.csv  (2 rows: one_shot, periodic)
  - experiments/final_experiment/tables/rul_summary.csv            (2 rows: one_shot, periodic)
  - experiments/final_experiment/tables/health_index_per_engine.csv (100 rows x 2 strategies, supplementary detail)
  - experiments/final_experiment/tables/rul_per_engine.csv          (100 rows x 2 strategies, supplementary detail)
  - both summary tables also printed to stdout.

Run from the repo root:
    python experiments/final_experiment/04_make_tables.py
"""
...
TABLE_DIR = "experiments/final_experiment/tables"
...
def main():
    ...
    print()
    print("=" * 78)
    print("TABLE 2 — RUL (final-cycle, same convention as day11_fullfleet_decision.md)")
    print("=" * 78)
