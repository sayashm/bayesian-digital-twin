"""
03_make_figures.py — FD003 final experiment, step 3: per-engine 2x2
comparison figure (health index + RUL, one-shot vs. periodic), read
straight back out of results.db (not from anything held in memory by
step 2). Same script as experiments/final_experiment/03_make_figures.py,
repointed at the FD003 pipeline's own config.json/figures directory.
...
FD003/02_run_experiment.py to have completed first):
    python experiments/final_experiment/library_method/FD003/03_make_figures.py
"""
...
FIG_DIR = "experiments/final_experiment/library_method/FD003/figures"
