...
Identical in content to PF_Fixed_Parameters/FD001/04_health_vs_rul.py /
library_method/FD001/05_health_vs_rul.py (same pooled-model config, same
...
own copy here (rather than a shared import) so PF_PMMH/FD001/ is
...
Run from the repo root:
    python experiments/final_experiment/PF_PMMH/FD001/04_health_vs_rul.py
"""
...
TRAIN_OUT_PATH = "experiments/final_experiment/PF_PMMH/FD001/figures/health_vs_rul_train.png"
TEST_OUT_PATH = "experiments/final_experiment/PF_PMMH/FD001/figures/health_vs_rul_test.png"
