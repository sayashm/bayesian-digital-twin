"""
03_make_tables.py — PF PMMH experiment, FD003: fleet-level summary tables
for Health Index and RUL, read back from results.db.

Same table schema, columns, and metric definitions as
PF_Fixed_Parameters/FD003/03_make_tables.py / library_method/FD003/
...
Run from the repo root:
    python experiments/final_experiment/PF_PMMH/FD003/03_make_tables.py
"""
...
TABLE_DIR = "experiments/final_experiment/PF_PMMH/FD003/tables"
