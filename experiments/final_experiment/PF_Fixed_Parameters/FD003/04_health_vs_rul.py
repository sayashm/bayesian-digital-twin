...
Identical in content to library_method/FD003/05_health_vs_rul.py (same
pooled-model config, same 10 representative engines) -- this diagnostic
is about the deterministic observed Health Index vs. ground-truth RUL, so
it does not depend on which downstream method (library matching or fixed
parameters) will later be used to predict RUL from it. Kept as its own
copy here (rather than a shared import) so PF_Fixed_Parameters/FD003/ is
self-contained and its figures/ directory is the one actually written to.
...
Run from the repo root:
    python experiments/final_experiment/PF_Fixed_Parameters/FD003/04_health_vs_rul.py
"""
...
TRAIN_OUT_PATH = "experiments/final_experiment/PF_Fixed_Parameters/FD003/figures/health_vs_rul_train.png"
TEST_OUT_PATH = "experiments/final_experiment/PF_Fixed_Parameters/FD003/figures/health_vs_rul_test.png"
