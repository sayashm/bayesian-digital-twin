"""
03_make_tables.py — PF Fixed-Parameters experiment, FD003: fleet-level
summary tables for Health Index and RUL, read back from results.db.

Same table schema, columns, and metric definitions as
library_method/FD003/04_make_tables.py's TABLE 1/TABLE 2 (see that
...
Run from the repo root:
    python experiments/final_experiment/PF_Fixed_Parameters/FD003/03_make_tables.py
"""
...
TABLE_DIR = "experiments/final_experiment/PF_Fixed_Parameters/FD003/tables"
